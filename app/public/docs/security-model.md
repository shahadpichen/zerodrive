...
The browser is trusted with plaintext because encryption and decryption happen there. The backend is trusted as a coordinator, not as a place for plaintext files or unencrypted keys.
...
The server should not know your recovery phrase, master key, private sharing key, plaintext files, plaintext filenames, plaintext messages, or unencrypted shared-file keys.
