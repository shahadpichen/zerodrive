  ...
  describe("GET /api/", () => {
    ...
    it("should include API name and description", async () => {
      ...
      expect(response.body.data.description).toBe(
        "End-to-end encrypted file storage backend",
      );
    });
    ...
    it("should have descriptive endpoint documentation", async () => {
      ...
      expect(endpoints["POST /api/webhooks/mailgun"]).toBe(
    ...
    it("should return consistent data structure", async () => {
      ...
      expect(response1.body.data.description).toBe(
        response2.body.data.description,
      );
